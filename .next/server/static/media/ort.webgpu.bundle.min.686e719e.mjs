...
var Kn, za, Kp, Da = U(()=>{
    "use strict";
    za = (Kn = import.meta.url, async function(e1 = {}) {
        function t() {
...
`,
        ...
        var Np = [
            ...
            return gn ||= u.locateFile ? Bo("ort-wasm-simd-threaded.jsep.wasm") ? "ort-wasm-simd-threaded.jsep.wasm" : u.locateFile ? u.locateFile("ort-wasm-simd-threaded.jsep.wasm", P) : P + "ort-wasm-simd-threaded.jsep.wasm" : new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href, (function(f, b) {
                var w = gn;
...
var Ra, jp, Ne, Ua, jn, Yp, Zp, Na, Qp, Ba, Va, Ma, Wa, xr = U(()=>{
    ...
    Ra = !1 || typeof location > "u" ? void 0 : location.origin, jp = ()=>{
        if (!!1) return import.meta.url?.startsWith("file:") ? new URL(new URL("ort.webgpu.bundle.min.mjs", import.meta.url).href, Ra).href : import.meta.url;
    }, Ne = jp(), Ua = ()=>{
        ...
        {
            let n = "ort-wasm-simd-threaded.jsep.mjs", o = e1 ?? Yp(n, t), i = !!1 && r && o && !jn(o, t), a = i ? await Na(o) : o ?? Zp(n, t);
            return [
                i ? a : void 0,
                await Qp(a)
            ];
            ...
            if (nr = !0, zt()) return new Promise((e1, t)=>{
                Le?.terminate(), Va().then(([r, n])=>{
                    try {
                        ...
                        !o.in.wasm.wasmPaths && (r || import.meta.url?.startsWith("file:")) && (o.in.wasm.wasmPaths = {
