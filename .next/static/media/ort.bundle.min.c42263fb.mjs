...
var Kn, za, Kp, Da = U(()=>{
    ...
    za = (Kn = import.meta.url, async function() {
        ...
        function qo() {
            var s = new Worker(import.meta.url.startsWith("file:") ? new URL("ort.bundle.min.mjs", import.meta.url) : new URL(import.meta.url), {
                type: "module",
...
var Ra, jp, Ne, Ua, jn, Yp, Zp, Na, Qp, Ba, Va, Ma, Wa, xr = U(()=>{
    ...
    Ra = !1 || typeof location > "u" ? void 0 : location.origin, jp = ()=>{
        var _url;
        if (!!1) return ((_url = import.meta.url) === null || _url === void 0 ? void 0 : _url.startsWith("file:")) ? new URL(new URL("ort.bundle.min.mjs", import.meta.url).href, Ra).href : import.meta.url;
    }, Ne = jp(), Ua = ()=>{
